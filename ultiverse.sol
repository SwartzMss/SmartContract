...
contract ultiverseDecoder {
    ...
    uint256 deadlineData = 1709036636;
	uint256 voyageIdData =203314;
	uint16[] destinationsData = [2,3,4];
	bytes32 dataData = 0x9f83f1bdc4255f9a81401c66eeac7004972f75e517c4552738b0e0d9cb2872b4;
	bytes signatureinfoData = hex"2c744dd258d055e9aad4814247cdf79aefdeab3bc949f04a08c13ef394b2e6bb3b3a8ff76762691ee59c4d3a8475cd5113079e0bcdf3c21b7ef14d5f4822fa171c";

    

    function encodeUltiverse() public view returns(bytes memory result) {
        result = abi.encode(deadlineData, voyageIdData, destinationsData, dataData,signatureinfoData);
    }
}
